...
%% V. SVM仿真预测
[Predict_1,error_1,prob_estimates1] = svmpredict(tn_train,pn_train,model);%训练集的一个预测
[Predict_2,error_2,prob_estimates2] = svmpredict(tn_test,pn_test,model);%测试集的预测
